        ...
        <header className="bg-gray-800 md:sticky top-0 z-10">
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700 flex flex-wrap items-center text-base justify-center">
              ...
              <a href="#skills" className="mr-0 md:mr-5 hover:text-white w-full text-center py-2 md:py-0 md:w-auto md:text-right">
                Skills
              </a>
              <a href="#testimonials" className="mr-0 md:mr-5 hover:text-white w-full text-center py-2 md:py-0 md:w-auto md:text-right">
                Recommendations
              </a>
            </nav>
            <a
